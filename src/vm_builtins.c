...
void VMBuiltins_setVariable(VMContext* ctx, Instance* inst, int16_t builtinVarId, const char* name, RValue val, int32_t arrayIndex) {
    ...
    switch (builtinVarId) {
        ...
        case BUILTIN_VAR_VIEW_XVIEW: {
            GMLCamera* camera = Runner_getCameraForView(runner, arrayIndex);
            if (camera != nullptr) {
                camera->viewX = (float)RValue_toReal(val);
        ...
        case BUILTIN_VAR_VIEW_YVIEW: {
            GMLCamera* camera = Runner_getCameraForView(runner, arrayIndex);
            if (camera != nullptr) {
                camera->viewY = (float)RValue_toReal(val);
                Runner_updateCameraViewSimple(camera);
            }
            return;
        }
...
static RValue builtin_matrix_build_projection_ortho(MAYBE_UNUSED VMContext *ctx, RValue *args, int32_t argCount) {
    ...
    Matrix4f mat;
    Matrix4f_Orthographic(&mat, (float)width, (float)height, (float)zfar, (float)znear);
...
static RValue builtin_matrix_get(MAYBE_UNUSED VMContext *ctx, RValue *args, int32_t argCount) {
    ...
    if (!toPrevMatrix) {
        ...
        repeat (16, i) {
            *GMLArray_slot(destArray, (int32_t)i) = RValue_makeReal(ctx->runner->renderer->gmlMatrices[Matrix].m[i]);
        }
        return RValue_makeArrayWeak(destArray);
    }
}
...
static RValue builtin_matrix_build_lookat(MAYBE_UNUSED VMContext *ctx, RValue *args, int32_t argCount) {
    ...
    Matrix4f_LookAt(&matrix, (float)xFrom, (float)yFrom, (float)zFrom, (float)xTo, (float)yTo, (float)zTo, (float)xUp, (float)yUp, (float)zUp);
...
static RValue builtin_camera_set_view_pos(VMContext* ctx, RValue* args, int32_t argCount) {
    ...
    GMLCamera* camera = Runner_getCameraById(runner, RValue_toInt32(args[0]));
    if (camera != nullptr) {
        camera->viewX = (float)RValue_toReal(args[1]);
        camera->viewY = (float)RValue_toReal(args[2]);
        Runner_updateCameraViewSimple(camera);
    }
    return RValue_makeUndefined();
}
...
static RValue builtin_camera_create_view(VMContext* ctx, RValue* args, int32_t argCount) {
    ...
    if (argCount > 0) camera->viewX = (float)RValue_toReal(args[0]);
    if (argCount > 1) camera->viewY = (float)RValue_toReal(args[1]);
...
static RValue builtin_draw_line_colour(VMContext* ctx, RValue* args, MAYBE_UNUSED int32_t argCount) {
    ...
    if (runner->renderer != nullptr) {
        ...
        runner->renderer->vtable->drawLineColor(runner->renderer, x1, y1, x2, y2, 1.0f, (uint32_t)col1, (uint32_t)col2, runner->renderer->drawAlpha);
    }
    return RValue_makeUndefined();
}
...
static RValue builtin_layer_sprite_speed(VMContext* ctx, RValue* args, MAYBE_UNUSED int32_t argCount) {
    ...
    RuntimeLayerElement* el = Runner_findLayerElementById(runner, id, nullptr);
    if (isValidLayerSpriteElement(el))
        el->spriteElement->animationSpeed = (float)RValue_toReal(args[1]);
    return RValue_makeUndefined();
}
...
static RValue builtin_draw_tile(VMContext* ctx, RValue* args, MAYBE_UNUSED int32_t argCount) {
    ...
    float dstX = (float)x + (mirror ? (float)tileW : 0.0f);
    float dstY = (float)y + (flip ? (float)tileH : 0.0f);
...
static RValue builtin_gpu_set_blendmode_ext_sepalpha(VMContext* ctx, RValue* args, int32_t argCount) {
    int sfactor = (int)RValue_toReal(args[0]);
    int dfactor = (int)RValue_toReal(args[1]);
    int sfactor_alpha = (int)RValue_toReal(args[2]);
    int dfactor_alpha = (int)RValue_toReal(args[3]);
...
static RValue builtin_sprite_get_info(VMContext* ctx, RValue* args, int32_t argCount) {
    ...
    VM_structSetAndFreeVal(ctx, ret, "type", RValue_makeBool(sprite->sSpriteType != 0), 6);
...
void VMBuiltins_registerAll(VMContext* ctx) {
    ...
    VM_registerBuiltin(ctx, "string_ord_at", (BuiltinFunc)builtin_string_ord_at);
    ...
    VM_registerBuiltin(ctx, "string_starts_with", (BuiltinFunc)builtin_string_starts_with);
	VM_registerBuiltin(ctx, "string_ends_with", (BuiltinFunc)builtin_string_ends_with);
    ...
    VM_registerBuiltin(ctx, "mean", (BuiltinFunc)builtin_mean);
    ...
    VM_registerBuiltin(ctx, "dot_product", (BuiltinFunc)builtin_dot_product);
    ...
    VM_registerBuiltin(ctx, "matrix_get", (BuiltinFunc)builtin_matrix_get);
    VM_registerBuiltin(ctx, "matrix_set", (BuiltinFunc)builtin_matrix_set);
    // Random
    ...
    VM_registerBuiltin(ctx, "view_get_xport", (BuiltinFunc)(BuiltinFunc)builtin_view_get_xport);
    ...
    VM_registerBuiltin(ctx, "camera_get_view_mat", (BuiltinFunc)builtin_camera_get_view_mat);
    VM_registerBuiltin(ctx, "camera_set_proj_mat", (BuiltinFunc)builtin_camera_set_proj_mat);
    VM_registerBuiltin(ctx, "camera_get_proj_mat", (BuiltinFunc)builtin_camera_get_proj_mat);
    ...
    VM_registerBuiltin(ctx, "ds_map_add_map", (BuiltinFunc)builtin_ds_map_add_map);
    VM_registerBuiltin(ctx, "ds_map_add_list", (BuiltinFunc)builtin_ds_map_add_list);
    VM_registerBuiltin(ctx, "ds_map_is_map", (BuiltinFunc)builtin_ds_map_is_map);
    VM_registerBuiltin(ctx, "ds_map_is_list", (BuiltinFunc)builtin_ds_map_is_list);
    ...
    // ds_priority
    VM_registerBuiltin(ctx, "ds_priority_create", (BuiltinFunc)builtin_ds_priority_create);
    VM_registerBuiltin(ctx, "ds_priority_clear", (BuiltinFunc)builtin_ds_priority_clear);
    VM_registerBuiltin(ctx, "ds_priority_copy", (BuiltinFunc)builtin_ds_priority_copy);
    VM_registerBuiltin(ctx, "ds_priority_destroy", (BuiltinFunc)builtin_ds_priority_destroy);
    VM_registerBuiltin(ctx, "ds_priority_size", (BuiltinFunc)builtin_ds_priority_size);
    VM_registerBuiltin(ctx, "ds_priority_empty", (BuiltinFunc)builtin_ds_priority_empty);
    VM_registerBuiltin(ctx, "ds_priority_add", (BuiltinFunc)builtin_ds_priority_add);
    VM_registerBuiltin(ctx, "ds_priority_delete_value", (BuiltinFunc)builtin_ds_priority_delete_value);
    VM_registerBuiltin(ctx, "ds_priority_change_priority", (BuiltinFunc)builtin_ds_priority_change_priority);
    VM_registerBuiltin(ctx, "ds_priority_find_priority", (BuiltinFunc)builtin_ds_priority_find_priority);
    VM_registerBuiltin(ctx, "ds_priority_delete_min", (BuiltinFunc)builtin_ds_priority_delete_min);
    VM_registerBuiltin(ctx, "ds_priority_delete_max", (BuiltinFunc)builtin_ds_priority_delete_max);
    VM_registerBuiltin(ctx, "ds_priority_find_min", (BuiltinFunc)builtin_ds_priority_find_min);
    VM_registerBuiltin(ctx, "ds_priority_find_max", (BuiltinFunc)builtin_ds_priority_find_max);
    VM_registerBuiltin(ctx, "ds_priority_write", (BuiltinFunc)builtin_ds_priority_write);
    VM_registerBuiltin(ctx, "ds_priority_read", (BuiltinFunc)builtin_ds_priority_read);
    ...
    VM_registerBuiltin(ctx, "audio_get_name", (BuiltinFunc)builtin_audio_get_name);
    ...
    VM_registerBuiltin(ctx, "audio_set_master_gain", (BuiltinFunc)builtin_audio_set_master_gain);
    ...
    VM_registerBuiltin(ctx, "window_get_caption", (BuiltinFunc)builtin_window_get_caption);
    ...
    VM_registerBuiltin(ctx, "window_set_cursor", (BuiltinFunc)builtin_window_set_cursor);
    VM_registerBuiltin(ctx, "window_get_cursor", (BuiltinFunc)builtin_window_get_cursor);
    ...
    VM_registerBuiltin(ctx, "instance_id_get", (BuiltinFunc)builtin_instance_id_get);
    if (!isGMS2) {
    ...
    VM_registerBuiltin(ctx, "filename_name", (BuiltinFunc)builtin_filename_name);
    ...
    VM_registerBuiltin(ctx, "draw_text_ext_color", (BuiltinFunc)builtin_draw_text_color_ext);
    ...
    VM_registerBuiltin(ctx, "draw_text_transformed_color", (BuiltinFunc)builtin_draw_text_color_transformed);
    VM_registerBuiltin(ctx, "draw_text_ext_transformed_color", (BuiltinFunc)builtin_draw_text_color_ext_transformed);
    ...
    if(!isGMS2) {
        ...
        VM_registerBuiltin(ctx, "draw_background_part", (BuiltinFunc)builtin_draw_background_part);
    ...
    VM_registerBuiltin(ctx, "draw_get_halign", (BuiltinFunc)builtin_draw_get_halign);
    VM_registerBuiltin(ctx, "draw_get_valign", (BuiltinFunc)builtin_draw_get_valign);
    ...
    VM_registerBuiltin(ctx, "sprite_set_bbox_mode", (BuiltinFunc)builtin_sprite_set_bbox_mode);
    ...
    if (isGMS2) {
        VM_registerBuiltin(ctx, "collision_line_list", (BuiltinFunc)builtin_collision_line_list);
        VM_registerBuiltin(ctx, "collision_rectangle_list", (BuiltinFunc)builtin_collision_rectangle_list);
        VM_registerBuiltin(ctx, "collision_circle_list", (BuiltinFunc)builtin_collision_circle_list);
    ...
    VM_registerBuiltin(ctx, "layer_sprite_speed", (BuiltinFunc)builtin_layer_sprite_speed);
    VM_registerBuiltin(ctx, "layer_sprite_blend", (BuiltinFunc)builtin_layer_sprite_blend);
	...
	VM_registerBuiltin(ctx, "tilemap_get_width", (BuiltinFunc)builtin_tilemap_get_width);
    VM_registerBuiltin(ctx, "tilemap_get_height", (BuiltinFunc)builtin_tilemap_get_height);
	VM_registerBuiltin(ctx, "tilemap_get_tile_width", (BuiltinFunc)builtin_tilemap_get_tile_width);
    VM_registerBuiltin(ctx, "tilemap_get_tile_height", (BuiltinFunc)builtin_tilemap_get_tile_height);
    VM_registerBuiltin(ctx, "tilemap_get_cell_x_at_pixel", (BuiltinFunc)builtin_tilemap_get_cell_x_at_pixel);
    VM_registerBuiltin(ctx, "tilemap_get_cell_y_at_pixel", (BuiltinFunc)builtin_tilemap_get_cell_y_at_pixel);
    VM_registerBuiltin(ctx, "tilemap_get", (BuiltinFunc)builtin_tilemap_get);
    VM_registerBuiltin(ctx, "tilemap_get_at_pixel", (BuiltinFunc)builtin_tilemap_get_at_pixel);
    VM_registerBuiltin(ctx, "tilemap_get_tileset", (BuiltinFunc)builtin_tilemap_get_tileset);
    VM_registerBuiltin(ctx, "tile_get_index", (BuiltinFunc)builtin_tile_get_index);
    VM_registerBuiltin(ctx, "tile_get_mirror", (BuiltinFunc)builtin_tile_get_mirror);
    ...
    VM_registerBuiltin(ctx, "gpu_get_blendmode", (BuiltinFunc)builtin_gpu_get_blendmode);
    VM_registerBuiltin(ctx, "gpu_get_blendmode_ext", (BuiltinFunc)builtin_gpu_get_blendmode_ext);
    VM_registerBuiltin(ctx, "gpu_get_blendmode_ext_sepalpha", (BuiltinFunc)builtin_gpu_get_blendmode_ext_sepalpha);
    ...
    VM_registerBuiltin(ctx,"gpu_set_blendmode_ext_sepalpha", (BuiltinFunc)builtin_gpu_set_blendmode_ext_sepalpha);
    ...
    VM_registerBuiltin(ctx,"gpu_set_colourwriteenable", (BuiltinFunc)builtin_gpu_set_colorwriteenable);
    VM_registerBuiltin(ctx,"gpu_get_colorwriteenable", (BuiltinFunc)builtin_gpu_get_colorwriteenable);
    VM_registerBuiltin(ctx,"gpu_get_colourwriteenable", (BuiltinFunc)builtin_gpu_get_colorwriteenable);
    ...
    VM_registerBuiltin(ctx, "shader_set_uniform_f_array", (BuiltinFunc)builtin_shader_set_uniform_f_array);
    ...
    VM_registerBuiltin(ctx, "sprite_get_speed", (BuiltinFunc)builtin_sprite_get_speed);
    VM_registerBuiltin(ctx, "sprite_get_speed_type", (BuiltinFunc)builtin_sprite_get_speed_type);
    ...
    VM_registerBuiltin(ctx, "sprite_get_info", (BuiltinFunc)builtin_sprite_get_info);
}
